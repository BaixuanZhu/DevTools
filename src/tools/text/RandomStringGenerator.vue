      ...
      <div class="flex flex-col gap-1">
        <div class="flex gap-2">
          <button
            ...
            class="px-6 py-2 bg-primary border border-primary text-primary-foreground rounded-sm text-[0.8125rem] font-sans cursor-pointer hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
            @click="generate"
          >
            生成
          </button>
