      ...
      <template #input>
        <CodePanel label="JSON 输入" showClear @clear="handleClear">
          <textarea
            ref="inputTextarea"
            v-model="inputText"
            class="w-full h-[calc(100vh-240px)] min-h-80 p-3 border border-border rounded-sm bg-card text-text font-mono text-sm resize-y focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1"
