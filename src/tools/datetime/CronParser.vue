  ...
  <div>
    ...
    <ResponsiveWorkspace mode="horizontal">
      <template #input>
        ...
        <!-- 可视化构建器 -->
        <div class="mb-3">
          <label class="block text-[0.8125rem] text-muted font-medium mb-2">可视化构建器</label>
      ...
      <template #output>
        ...
        <div v-else-if="!errorMsg" class="px-4 py-6 border border-border rounded-sm bg-card text-center">
