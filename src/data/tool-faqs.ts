...
const toolFaqs: Record<string, FaqItem[]> = {
  ...
  'image-scrambler': [
    ...
    },
    {
      ...
      answer: '块级置乱是一种<strong>可逆变换</strong>，但还原必须使用与置乱完全相同的<strong>种子和块大小</strong>，否则置换顺序对不上、无法还原。本工具会在切换「置乱/还原」模式时保留当前参数，方便你直接使用。',
    },
    {
      question: '块大小应该怎么选？',
      answer: '块大小决定重排的颗粒度：<strong>小块（如 2×2）</strong>打散更细，结果更接近噪点；<strong>大块（如 16×16）</strong>置换表更小、速度更快，但结果保留明显的拼图块轮廓。可在 2、4、8、16 之间按需切换。',
    },
    {
